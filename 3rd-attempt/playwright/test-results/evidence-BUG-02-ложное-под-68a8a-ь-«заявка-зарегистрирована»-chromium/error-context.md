...
- Name: evidence.spec.js >> BUG-02: ложное подтверждение при ошибке сервера >> при HTTP 500 пользователь не должен видеть «заявка зарегистрирована»
- Location: evidence.spec.js:37:3
...
- generic [ref=e2]:
  ...
  - generic [ref=e15]:
    ...
    - generic [ref=e18]:
      ...
      - textbox [ref=e24]: 2026-09-01
      - generic [ref=e25]: Дата отъезда
      - textbox [ref=e26]: 2026-09-05
      ...
      - generic [ref=e34]: Спасибо, ваша заявка зарегистрирована!
  - generic [ref=e35]:
    ...
    - paragraph [ref=e39]: Marsel Fatkhullin 2023
```

...
- Name: bug-01-date-range.spec.js >> BUG-01: интервал дат в форме бронирования >> форма не должна считаться валидной, если отъезд раньше заезда
- Location: bug-01-date-range.spec.js:28:3

# Error details

```
Error: форма с датой отъезда раньше даты заезда прошла валидацию
